...
describe('objectToEnv()', () => {
	it('should convert and object to environment variable definitions', () => {
		expect(
			objectToEnv({
			...
			[
				'WEBSITE_BUCKET_NAME=bifravst-websitbucketc74c6fbf-e126q3sws4eq',
				...
				'WEBSITE_DOMAIN_NAME=bifravst-websitbucketc74c6fbf-e126q3sws4eq.s3.eu-central-1.amazonaws.com',
				'',
			].join(os.EOL),
		)
	})
